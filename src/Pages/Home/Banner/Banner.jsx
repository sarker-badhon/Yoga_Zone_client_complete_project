          ...
          <div className="hero min-h-screen" style={{ backgroundImage: `url(${slider1})` }}>
            ...
            <div className="hero-content text-center text-neutral-content">
              ...
              <h1 className="mb-5 text-5xl font-bold space-x-3 tracking-wide animate-zoom-in">WELCOME TO OUR YOGAZONE</h1>
                <p className="mb-5 text-xl ">Yoga is an ancient system of physical, mental and spiritual practices that have been passed down through the generations from teacher to student. Yogic practices include breathing techniques, postures, relaxation, chanting, and other meditation methods. There are many different styles of yoga, each with their own unique focus and approach to creating a unitive state.</p>
